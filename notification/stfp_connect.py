...
def password_and_key_sftp_clien(host, port, host_keys, username, password, pkey):
...
def get_sftp_client(
    ...
    if (pkey and not password) or (password and not pkey):
        ...
        return password_and_key_sftp_clien(host, port, host_keys, username, password, pkey)
