    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={
                ...
                "verbose_name_plural": "Payment Card to Membership Card Associations",
            },
        ),
        ...
        migrations.AlterField(
            ...
            name="user",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name="Associated User"
            ),
        ),
        migrations.AlterField(
