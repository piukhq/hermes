...
from scheme.models import Image, Scheme, SchemeImage
...
def send_mail(
    ...
    mail = EmailMultiAlternatives(
        subject, message, from_email, recipient_list, reply_to=reply_to, connection=connection
    )
    if html_message:
...
def send_magic_link(magic_link_data: MagicLinkData):
    ...
    send_mail(
        ...
        from_email=magic_link_data.email_from
        or settings.DEFAULT_MAGIC_LINK_FROM_EMAIL.format(external_name=magic_link_data.external_name),
