    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="scheme_account_set", through="ubiquity.SchemeAccountEntry", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                choices=[(0, "text"), (1, "sensitive"), (2, "choice"), (3, "boolean")], default=0
            ),
        ),
        migrations.AddField(
            model_name="schemecredentialquestion",
