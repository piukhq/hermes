    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_app', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client_app', to='user.ClientApplication')),
                ('consent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='consent', to='scheme.Consent')),
                ('scheme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='scheme', to='scheme.Scheme')),
            ],
        ),
