...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("scheme", "0005_auto_20150923_1044"),
        ("scheme", "0005_auto_20150923_1024"),
        ("scheme", "0006_merge"),
        ...
        ("scheme", "0030_remove_schemecredentialquestion_encrypt_answer"),
        ("scheme", "0029_auto_20151016_1330"),
        ("scheme", "0031_merge"),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "barcode_regex",
                    models.CharField(
                        blank=True, help_text="Regex to map card number to barcode", max_length=100, null=True
                    ),
                ),
                (
                    "card_number_regex",
                    models.CharField(
                        blank=True, help_text="Regex to map barcode to card number", max_length=100, null=True
                    ),
                ),
                (
                    "barcode_prefix",
                    models.CharField(
                        blank=True, help_text="Prefix to from card number -> barcode mapping", max_length=100, null=True
                    ),
                ),
                (
                    "card_number_prefix",
                    models.CharField(
                        blank=True, help_text="Prefix to from barcode -> card number mapping", max_length=100, null=True
                    ),
                ),
                (
                    "barcode_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scheme",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="images", to="scheme.Scheme"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "scheme",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="questions", to="scheme.Scheme"
                    ),
                ),
                (
                    "type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question",
                    models.ForeignKey(
                        null=True, on_delete=django.db.models.deletion.CASCADE, to="scheme.SchemeCredentialQuestion"
                    ),
                ),
            ],
        ),
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[
                    ...
                    (4, "deleted"),
                    (5, "incomplete"),
                    (6, "account locked on end site"),
                    (7, "Cannot connect, too many retries"),
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, related_name="questions", to="scheme.Scheme"
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name="question",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.PROTECT, to="scheme.SchemeCredentialQuestion"
            ),
        ),
