...
from scheme.models import Consent, JourneyTypes, Scheme, slug_regex, validate_hex_colour
...
class SchemeForm(ModelForm):
    secondary_colour = forms.CharField(
        validators=[validate_hex_colour], required=False, help_text='Hex string e.g "#112233"'
    )
