...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='paymentcardaccountimage',
            name='payment_card',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='payment_card.PaymentCard'),
        ),
        migrations.AddField(
            model_name='paymentcardaccountimage',
            name='payment_card_accounts',
            field=models.ManyToManyField(related_name='payment_card_accounts_set', to='payment_card.PaymentCardAccount'),
        ),
        migrations.AddField(
            model_name='paymentcardaccountimage',
            name='start_date',
