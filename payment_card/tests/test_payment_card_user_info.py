...
class TestPaymentCardUserInfo(APITestCase):
    ...
    def setUpClass(cls):
        ...
        payment_card_factories.PaymentCardAccountEntryFactory(payment_card_account=cls.payment_card_account_1,
                                                              user=cls.user_1)
        payment_card_factories.PaymentCardAccountEntryFactory(payment_card_account=cls.payment_card_account_2,
                                                              user=cls.user_2)
        payment_card_factories.PaymentCardAccountEntryFactory(payment_card_account=cls.payment_card_account_3,
                                                              user=cls.user_3)
        ...
        scheme_factories.SchemeAccountEntryFactory(scheme_account=cls.scheme_account_1, user=cls.user_1)
        scheme_factories.SchemeAccountEntryFactory(scheme_account=cls.scheme_account_2, user=cls.user_2)
        scheme_factories.SchemeAccountEntryFactory(scheme_account=cls.scheme_account_3, user=cls.user_3)
