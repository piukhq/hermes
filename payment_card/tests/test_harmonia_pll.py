...
class TestPaymentCardUserInfo(GlobalMockAPITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.scheme_account_entry_1 = ubiquity.tests.factories.SchemeAccountEntryFactory(scheme_account=cls.scheme_account_1, user=cls.user_1)
        cls.scheme_account_entry_2 = ubiquity.tests.factories.SchemeAccountEntryFactory(scheme_account=cls.scheme_account_2, user=cls.user_2)
        cls.scheme_account_entry_3 = ubiquity.tests.factories.SchemeAccountEntryFactory(scheme_account=cls.scheme_account_3, user=cls.user_3)
        ...
        cls.scheme_answer_3 = scheme_factories.SchemeCredentialAnswerFactory(
            scheme_account=cls.scheme_account_3, question=cls.scheme_question,
