...
from payment_card.views import RetrievePaymentCardAccount, RetrievePaymentCardSchemeAccounts,\
    ListPaymentCard, CreatePaymentCardAccount, RetrieveLoyaltyID, RetrievePaymentCardUserInfo, csv_upload
...
urlpatterns = patterns('payment_card',
                       ...
                       url(r'^/accounts/payment_card_user_info/(?P<scheme_slug>.+)$', RetrievePaymentCardUserInfo.as_view(),
