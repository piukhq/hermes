    ...
    "client-decommission": {
        ...
        "script_kwargs": {
            ...
            "client_name": {
                "flags": ["--client-name", "-c"],
                "type": str,
                "help": "name field of the ClientApplicationBundle to decommission",
                "required": True,
            },
            "exclude_test_users": {
                "flags": ["--exclude-test-users", "-e"],
                "action": "store_true",
                "help": "excludes test users from deletion",
            },
            "batch_size": {
                "flags": ["--batch-size", "-b"],
                "type": int,
