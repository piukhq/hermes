...
from .find_errors.channel_retailer_offboarding import FindBarclaysWasabiMembershipCards
...
class DataScripts(IntEnum):
    ...
    BARCLAYS_WASABI_RETAILER_CARDS = auto()
...
SCRIPT_TITLES = {
    ...
    DataScripts.BARCLAYS_WASABI_RETAILER_CARDS: "Barclays Wasabi membership cards for unboarding",
}
...
SCRIPT_CLASSES = {
    ...
    DataScripts.BARCLAYS_WASABI_RETAILER_CARDS: FindBarclaysWasabiMembershipCards,
}
