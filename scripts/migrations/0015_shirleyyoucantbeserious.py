# Generated by Django 4.2.10 on 2024-03-11 11:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[(scripts.enums.ShirleyStatuses['READY'], 'Ready'), (scripts.enums.ShirleyStatuses['IN_PROGRESS'], 'In Progress'), (scripts.enums.ShirleyStatuses['DONE'], 'Done')], db_index=True, default=scripts.enums.ShirleyStatuses['READY'], max_length=12)),
