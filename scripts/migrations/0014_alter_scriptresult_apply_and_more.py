...
class Migration(migrations.Migration):
    dependencies = [
        ("scripts", "0013_alter_scriptresult_apply_and_more"),
    ]
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[
                    ...
                    (2009, "Soft delete a payment card and send a un-enroll request to Metis"),
                    (4001, "Delete card links for deleted Users"),
                    (5001, "Run delete process for Bink client users"),
                    (6001, "Offboard membership cards for specific retailer and channels"),
                ],
                db_index=True,
                default=0,
