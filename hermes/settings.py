...
# SFTP DETAILS
SFTP_HOST = env_var("SFTP_HOST", "localhost")
SFTP_USERNAME = env_var("SFTP_USERNAME", "")
SFTP_PASSWORD = env_var("SFTP_PASSWORD", "")

# 2 hours
NOTIFICATION_PERIOD = env_var("NOTIFICATION_PERIOD", 7200)
NOTIFICATION_ERROR_THRESHOLD = env_var("NOTIFICATION_ERROR_THRESHOLD", 5)
# 2 minutes
NOTIFICATION_RETRY_TIMER = env_var("NOTIFICATION_RETRY_TIMER", 5)
