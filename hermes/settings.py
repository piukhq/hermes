...
OIDC_RP_CLIENT_ID = env_var("ODIC_CLIENT_ID", "cf6d5fc9-f503-442e-9dec-2cdf714143db")
OIDC_RP_CLIENT_SECRET = env_var("ODIC_CLIENT_SECRET", "Y35e1b~qGQ4X02-sfs3638Wy1Zxb.-.tl2")
