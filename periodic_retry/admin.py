...
add_visa_active_user.short_description = "Add VISA Active User"
...
enrol_visa_user.short_description = "Trigger Enrolment"
...
class PeriodicRetryAdmin(admin.ModelAdmin):
    ...
    actions = [add_visa_active_user, enrol_visa_user, ]
